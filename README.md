...
3. **Ask the council** in one of two scopes:
   ...
   - _Plan only_ — file tools are stripped; the answer stands on reasoning alone.
...
```bash
# 1. the agent runtime — serves its console and API on :8790
...
profiles/       Persona packs — SKILL.md + profile.yaml per reviewer voice.
...
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — how the pieces fit, the verified
  TrueForge API surface, and why each stack choice was made.
